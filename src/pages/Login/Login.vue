            ...
            <section>
              ...
              <section class="login_verification">
                ...
                <div class="switch_button" :class="showPwd?'on':'off'" @click="showPwd=!showPwd">
                  ...
                  <span class="switch_text">{{ showPwd?'取消':'' }}</span>
                </div>
              </section>
              <section class="login_message">
                <input type="text" maxlength="11" placeholder="验证码" v-model="captcha" ref="inpCaptcha">
